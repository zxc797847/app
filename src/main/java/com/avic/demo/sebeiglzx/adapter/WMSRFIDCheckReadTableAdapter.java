...
public class WMSRFIDCheckReadTableAdapter extends BaseAdapter {
	private List<InitProRfidFkbBean> list;
	private LayoutInflater inflater;

	public WMSRFIDCheckReadTableAdapter(Context context, List<InitProRfidFkbBean> list) {
		this.list = list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.list_wms_check_read_item, null);
			...
			viewHolder.tv_HGSL = (TextView) convertView.findViewById(R.id.tv_HGSL);
		...
		viewHolder.tv_HGSL.setText(proRfidFkbBean.getHgsl() + "");
		viewHolder.tv_HGSL.setTextSize(13);
