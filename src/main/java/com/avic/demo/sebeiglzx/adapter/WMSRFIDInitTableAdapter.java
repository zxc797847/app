...
public class WMSRFIDInitTableAdapter extends BaseAdapter {
	private List<InitProRfidFkbBean> list;
	private LayoutInflater inflater;

	public WMSRFIDInitTableAdapter(Context context, List<InitProRfidFkbBean> list) {
		this.list = list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.init_list_item, null);
