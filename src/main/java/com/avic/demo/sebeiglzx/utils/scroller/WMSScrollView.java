...
public class WMSScrollView extends LinearLayout {
    ...
    public WMSScrollView(Context context) {
        this(context, null);
    }

    public WMSScrollView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WMSScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
